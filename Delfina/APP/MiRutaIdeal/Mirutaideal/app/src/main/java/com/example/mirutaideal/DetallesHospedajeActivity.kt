...
class DetallesHospedajeActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mapButton: ImageButton = findViewById(R.id.icon_map_detalles_hospedaje)
        mapButton.setOnClickListener {
            val intent = Intent(this, MapActivity::class.java)
            startActivity(intent)
        }
        val homeButton: ImageButton = findViewById(R.id.icon_home_page_button_detalles_hospedaje)
        homeButton.setOnClickListener{
            val intent = Intent(this, PantallaInicioActivity::class.java)
            startActivity(intent)
        }
        val searchButton: ImageButton= findViewById(R.id.icon_route_detalles_hospedaje)
        searchButton.setOnClickListener{
            val intent = Intent(this, SearchActivity::class.java)
            startActivity(intent)
        }
        val drawerLayout: DrawerLayout = findViewById(R.id.drawerLayout_detalles_hospedaje)
        val navView: NavigationView = findViewById(R.id.nav_view_detalles_hospedaje)
        val navViewPerfil: NavigationView = findViewById(R.id.nav_view_perfil_detalles_hospedaje)
        ...
        val iconMenuButton: ImageButton = findViewById(R.id.icon_menu_detalles_hospedaje)
        iconMenuButton.setOnClickListener {
            drawerLayout.openDrawer(GravityCompat.START)
        }
        val comodidadesText: TextView = findViewById(R.id.text_comodidades)
        comodidadesText.setOnClickListener {
            val alertDialog: android.app.AlertDialog = android.app.AlertDialog.Builder(this)
                .setTitle("Comodidades")
                .setMessage("Durante tu estancia, tendrás acceso a las siguientes comodidades básicas:\n" +
                        "\n" +
                        "• Cama o colchón con ropa de cama  \n" +
                        "• Baño privado con agua caliente  \n" +
                        "• Toalla  \n" +
                        "• Electricidad y enchufes disponibles  \n" +
                        "• Wi-Fi (disponibilidad limitada en zonas remotas)  \n" +
                        "• Desayuno incluido  \n" +
                        "• Cena casera disponible bajo reserva  \n" +
                        "• Zona común para descansar  \n" +
                        "• Espacio para guardar mochilas  \n" +
                        "• Botiquín de primeros auxilios  \n" +
                        "• Información sobre rutas y clima  \n" +
        ...
        val addButton: ImageButton= findViewById(R.id.icon_add_detalles_hospedaje)
        ...
        val iconProfileButton: ImageButton = findViewById(R.id.icon_profile_detalles_hospedaje)
