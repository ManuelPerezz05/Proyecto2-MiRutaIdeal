...
class DetallesRestauranteActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mapButton: ImageButton = findViewById(R.id.icon_map_detalles_restaurante)
        mapButton.setOnClickListener {
            val intent = Intent(this, MapActivity::class.java)
            startActivity(intent)
        }
        val homeButton: ImageButton = findViewById(R.id.icon_home_page_button_detalles_restaurante)
        homeButton.setOnClickListener{
            val intent = Intent(this, PantallaInicioActivity::class.java)
            startActivity(intent)
        }
        val searchButton: ImageButton= findViewById(R.id.icon_route_detalles_restaurante)
        searchButton.setOnClickListener{
            val intent = Intent(this, SearchActivity::class.java)
            startActivity(intent)
        }
        val drawerLayout: DrawerLayout = findViewById(R.id.drawerLayout_detalles_restaurante)
        val navView: NavigationView = findViewById(R.id.nav_view_detalles_restaurante)
        val navViewPerfil: NavigationView = findViewById(R.id.nav_view_perfil_detalles_restaurante)
        ...
        val iconMenuButton: ImageButton = findViewById(R.id.icon_menu_detalles_restaurante)
        ...
        val addButton: ImageButton= findViewById(R.id.icon_add_detalles_restaurante)
        ...
        val iconProfileButton: ImageButton = findViewById(R.id.icon_profile_detalles_restaurante)
